...
export const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'A MERN-based e-commerce platform designed for college students to buy, sell, and exchange items within the campus. It simplifies student-to-student transactions with features like product listing, chat, secure authentication, and campus-restricted access.',
      techStack: ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'JWT Authentication', 'Cloudinary', 'Tailwind CSS'],
